...
class PatternsNew:
    ...
    def _get_sketches(self) -> List[Layout]:
        ...
        # Miniribs are now handled by PlotMaker.get_miniribs() 
        # and placed between RIBS and DRIBS frames
    ...
    def _get_plotfile(self):
        ...
        if complete:
            ...
            # dynamic _asym_left_panels attribute. A cached GliderInstance may
            # have lost it (it is not serialized) or hold a stale one, which
