...
class ArcCommand(BaseCommand):
    def GetResources(self):
        return {"Pixmap": "arc_command.svg", "MenuText": "arc", "ToolTip": "modify arc"}
...
class AirfoilMergeCommand(BaseCommand):
    def GetResources(self):
        return {
            "Pixmap": "airfoil_merge_command.svg",
...
class BallooningMergCommand(BaseCommand):
    def GetResources(self):
        return {
            "Pixmap": "ballooning_merge_command.svg",
...
class GliderBallooningFeatureCommand(GliderFeatureCommand):
    ...
    def Activated(self):
        feature = FreeCAD.ActiveDocument.addObject(
            "App::FeaturePython", "ballooningFeature"
        )
...
class ImportDXFCommand:
    ...
    def GetResources(self):
        return {
            "Pixmap": "dxf_command.svg",
            "MenuText": "fast dxf import",
            "ToolTip": "fast dxf import",
        }
