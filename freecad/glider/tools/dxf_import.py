...
GC_INT16 = np.concatenate(
    (np.arange(60, 79), np.arange(170, 175), np.arange(400, 409), np.arange(1060, 1070))
)
...
class DXFEntity:
    ...
    def value(self, gc):
        return self.groupcodes[gc]

    def type(self):
        self.groupcodes[GC_ENTITY_TYPE]

    def handle(self):
        self.groupcodes[GC_HANDLE]
...
class DXFVertex(DXFEntity):
    ...
    def x(self):
        return self.value(GC_X)

    def y(self):
        return self.value(GC_Y)

    def z(self):
        return self.value(GC_Z)
...
class DXFLine(DXFEntity):
    ...
    def x2(self):
        return self.value(GC_X + 1)

    def y2(self):
        return self.value(GC_Y + 1)

    def z2(self):
        return self.value(GC_Z + 1)
...
class DXFFACE(DXFEntity):
    ...
    def x3(self):
        return self.value(GC_X + 2)

    def y3(self):
        return self.value(GC_Y + 2)

    def z3(self):
        return self.value(GC_Z + 2)

    def x4(self):
        return self.value(GC_X + 3)

    def y4(self):
        return self.value(GC_Y + 3)

    def z4(self):
        return self.value(GC_Z + 3)
...
class DXFSpline(DXFEntity):
    ...
    def is_closed(self):
        return self.value(70) << 1

    def is_periodic(self):
        return self.value(70) << 2

    def is_rational(self):
        return self.value(70) << 4

    def is_planar(self):
        return self.value(70) << 8
    ...
    def to_polygon(self):
        ...
        for i in np.arange(len(self.value(GC_X))):
            poly.append(
                FreeCAD.Vector(
                    self.value(GC_X)[i], self.value(GC_Y)[i], self.value(GC_Z)[i]
                )
            )
